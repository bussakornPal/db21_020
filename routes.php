<?php
$controllers = array('pages'=>['home','error'],'order'=>['index','newOrder','addOrder','search','updateForm','update','deleteConfirm','delete'],'detail_order'=>['index','newdetail_order','search','adddetail_order'],'range_price'=>['index','newrange_price']);
