<?php
$controllers = array('pages'=>['home','error'],'order'=>['index','newOrder','addOrder','search','updateForm','update','deleteConfirm'],'detail_order'=>['index','newdetail_order'],'range_price'=>['index','newrange_price']);
