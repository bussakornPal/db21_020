...
<label>รหัส <input type="text" name="id_order_cus" value="<?php echo $order->id_order_cus;?>"/></label><br>
<label>วันที่ <input type="date" name="date_order"value="<?php echo $order->date_order;?>"/></label><br>
